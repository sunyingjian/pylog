...
def train_useRFR(data,options):
    model = make_pipeline(StandardScaler(),RandomForestRegressor(n_estimators=int(options['n_estimators']),
...
class Downleft(init_ui.downleft):
    ...
    def tab3UI(self):
        ...
        self.combox_criterion.setItemText(1, "mae")
